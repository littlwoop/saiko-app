...
export const translations = {
  de: {
    ...
    collaborativeChallenge: "Gemeinsame Herausforderung (alle Teilnehmer tragen zu gemeinsamen Zielen bei)",
  ...
  en: {
    ...
    collaborativeChallenge: "Collaborative Challenge (all participants contribute to shared objectives)",
